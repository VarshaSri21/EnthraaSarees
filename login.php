...
//display_name('test');
// checking for POST (form data) 
if(isset($_POST['username'])){
  //if form data is available pass it into variables
  $username=$_POST['username'];
  $password=$_POST['password'];
  // creating query to check with database using received data through POST
  ...
  if(mysqli_num_rows($result) > 0){
    ...
    // user available  assign session
    $_SESSION["user_id"] = $row['id'];
    $_SESSION["user_name"] = $row['username'];
    echo $_SESSION['user_name'];
    header('location:index.php');
  }else{
    // user not found goto login
...
<!--<div class="wrapper fadeInDown">
    <div id="formContent">
      ...
      <form method="post">
        <input type="text" id="username" class="fadeIn second field" name="username" placeholder="USERNAME">
        <input type="password" id="password" class="fadeIn third field" name="password" placeholder="PASSWORD">
